...
pub struct WDU_R(crate::FieldReader<u8, WDU_A>);
impl WDU_R {
    pub(crate) fn new(bits: u8) -> Self {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<WDU_A> {
        match self.bits {
            0 => Some(WDU_A::B_0X0),
            1 => Some(WDU_A::B_0X1),
            7 => Some(WDU_A::B_0X7),
...
impl core::ops::Deref for WDU_R {
    type Target = crate::FieldReader<u8, WDU_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> WDU_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: WDU_A) -> &'a mut W {
