...
pub struct LPUART2RST_R(crate::FieldReader<bool, bool>);
impl LPUART2RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        LPUART2RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LPUART2RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LPUART2RST_W<'a> {
    w: &'a mut W,
}
impl<'a> LPUART2RST_W<'a> {
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn lpuart2rst(&self) -> LPUART2RST_R {
        LPUART2RST_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ///Bit 8 - USART5RST
    #[inline(always)]
    pub fn usart5rst(&self) -> USART5RST_R {
        USART5RST_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    ///Bit 9 - USART6RST
    #[inline(always)]
    pub fn usart6rst(&self) -> USART6RST_R {
        USART6RST_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    ///Bit 12 - FDCANRST
    #[inline(always)]
    pub fn fdcanrst(&self) -> FDCANRST_R {
        FDCANRST_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    ///Bit 13 - USBRST
    #[inline(always)]
    pub fn usbrst(&self) -> USBRST_R {
        USBRST_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    ///Bit 14 - SPI2 reset
    #[inline(always)]
    ...
    pub fn crsrst(&self) -> CRSRST_R {
        CRSRST_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    ///Bit 17 - USART2 reset
    #[inline(always)]
...
impl W {
    ...
    ///Bit 7 - LPUART2RST
    #[inline(always)]
    pub fn lpuart2rst(&mut self) -> LPUART2RST_W {
        LPUART2RST_W { w: self }
    }
    ///Bit 8 - USART5RST
    #[inline(always)]
