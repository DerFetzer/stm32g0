...
///Field `PD15` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD15` writer - Port D pull-down bit y (y=0..15)
pub struct PD15_W<'a> {
    w: &'a mut W,
}
impl<'a> PD15_W<'a> {
...
///Field `PD14` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD14` writer - Port D pull-down bit y (y=0..15)
pub struct PD14_W<'a> {
    w: &'a mut W,
}
impl<'a> PD14_W<'a> {
...
///Field `PD13` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD13` writer - Port D pull-down bit y (y=0..15)
pub struct PD13_W<'a> {
    w: &'a mut W,
}
impl<'a> PD13_W<'a> {
...
///Field `PD12` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD12` writer - Port D pull-down bit y (y=0..15)
pub struct PD12_W<'a> {
    w: &'a mut W,
}
impl<'a> PD12_W<'a> {
...
///Field `PD11` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD11` writer - Port D pull-down bit y (y=0..15)
pub struct PD11_W<'a> {
    w: &'a mut W,
}
impl<'a> PD11_W<'a> {
...
///Field `PD10` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD10` writer - Port D pull-down bit y (y=0..15)
pub struct PD10_W<'a> {
    w: &'a mut W,
}
impl<'a> PD10_W<'a> {
...
///Field `PD7` reader - Port D pull-down bit y (y=0..15)
...
///Field `PD7` writer - Port D pull-down bit y (y=0..15)
pub struct PD7_W<'a> {
    w: &'a mut W,
}
impl<'a> PD7_W<'a> {
