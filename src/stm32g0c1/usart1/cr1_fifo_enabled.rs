///Register `CR1_FIFO_ENABLED` reader
...
///Register `CR1_FIFO_ENABLED` writer
...
///`read()` method returns [cr1_fifo_enabled::R](R) reader structure
impl crate::Readable for CR1_FIFO_ENABLED_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cr1_fifo_enabled::W](W) writer structure
impl crate::Writable for CR1_FIFO_ENABLED_SPEC {
    type Writer = W;
}
///`reset()` method sets CR1_FIFO_ENABLED to value 0
