...
///`read()` method returns [chep3r::R](R) reader structure
impl crate::Readable for CHEP3R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep3r::W](W) writer structure
impl crate::Writable for CHEP3R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP3R to value 0
