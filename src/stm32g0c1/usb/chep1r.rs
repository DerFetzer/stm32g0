...
///`read()` method returns [chep1r::R](R) reader structure
impl crate::Readable for CHEP1R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep1r::W](W) writer structure
impl crate::Writable for CHEP1R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP1R to value 0
