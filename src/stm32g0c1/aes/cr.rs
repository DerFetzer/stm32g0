...
///Field `CHMOD1` reader - Chaining mode selection, bit \[2\]
...
///Field `CHMOD1` writer - Chaining mode selection, bit \[2\]
///Refer to the bits \[5:6\]
///of the register for the description of the CHMOD\[2:0\]
///bitfield CHMOD\[1:0\]: Chaining mode selection, bits \[1:0\]
///This bitfield, together with the bit CHMOD\[2\]
...
///DMA input enable This bit enables/disables data transferring with DMA, in the input phase: When the bit is set, DMA requests are automatically generated by AES during the input data phase. This feature is only effective when Mode 1 or Mode 3 is selected through the MODE\[1:0\]
...
///DMA output enable This bit enables/disables data transferring with DMA, in the output phase: When the bit is set, DMA requests are automatically generated by AES during the output data phase. This feature is only effective when Mode 1 or Mode 3 is selected through the MODE\[1:0\]
///bitfield. It is not effective for Mode 2 (key derivation). Usage of DMA with Mode 4 (single decryption) is not recommended.
///
///Value on reset: 0
#[derive(Clone, Copy, Debug, PartialEq)]
...
///Field `CHMOD2` reader - Chaining mode selection, bit \[2\]
///Refer to the bits \[5:6\]
///of the register for the description of the CHMOD\[2:0\]
///bitfield CHMOD\[1:0\]: Chaining mode selection, bits \[1:0\]
///This bitfield, together with the bit CHMOD\[2\]
...
///Field `CHMOD2` writer - Chaining mode selection, bit \[2\]
///Refer to the bits \[5:6\]
///of the register for the description of the CHMOD\[2:0\]
///bitfield CHMOD\[1:0\]: Chaining mode selection, bits \[1:0\]
///This bitfield, together with the bit CHMOD\[2\]
...
#[repr(u8)]
pub enum NPBLB_A {
    ///0: All bytes are valid (no padding)
    B_0X0 = 0,
    ///1: Padding for one least-significant byte of last block
    B_0X1 = 1,
    ///15: Padding for 15 least-significant bytes of last block
    B_0XF = 15,
}
...
impl R {
    ...
    ///Bits 5:6 - Chaining mode selection, bit \[2\]
    ///Refer to the bits \[5:6\]
    ///of the register for the description of the CHMOD\[2:0\]
    ///bitfield CHMOD\[1:0\]: Chaining mode selection, bits \[1:0\]
    ///This bitfield, together with the bit CHMOD\[2\]
