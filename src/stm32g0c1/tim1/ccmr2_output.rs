...
pub enum CC3S_A {
    ...
    B_0X2 = 2,
    ///3: CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register)
    B_0X3 = 3,
}
...
///Field `CC3S` reader - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â in TIMx_CCER).
...
///Field `CC3S` writer - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â in TIMx_CCER).
pub struct CC3S_W<'a> {
    w: &'a mut W,
}
impl<'a> CC3S_W<'a> {
...
///Output compare 3 mode Refer to OC1M\[3:0\]
///description.
///
///Value on reset: 0
#[derive(Clone, Copy, Debug, PartialEq)]
...
///Field `OC3M` reader - Output compare 3 mode Refer to OC1M\[3:0\]
///description.
...
///Field `OC3M` writer - Output compare 3 mode Refer to OC1M\[3:0\]
///description.
pub struct OC3M_W<'a> {
    w: &'a mut W,
}
...
pub enum CC4S_A {
    ...
    B_0X2 = 2,
    ///3: CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register)
    B_0X3 = 3,
}
...
///Field `CC4S` reader - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â in TIMx_CCER).
...
///Field `CC4S` writer - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â in TIMx_CCER).
pub struct CC4S_W<'a> {
    w: &'a mut W,
}
impl<'a> CC4S_W<'a> {
...
///Output compare 4 mode Refer to OC3M\[3:0\]
///description.
pub type OC4M_A = OC3M_A;
///Field `OC4M` reader - Output compare 4 mode Refer to OC3M\[3:0\]
///description.
pub type OC4M_R = OC3M_R;
///Field `OC4M` writer - Output compare 4 mode Refer to OC3M\[3:0\]
///description.
pub struct OC4M_W<'a> {
    w: &'a mut W,
}
...
///Field `OC3M_3` reader - Output compare 3 mode Refer to OC1M\[3:0\]
///description.
...
///Field `OC3M_3` writer - Output compare 3 mode Refer to OC1M\[3:0\]
///description.
...
///Field `OC4M_3` reader - Output compare 4 mode Refer to OC3M\[3:0\]
///description.
pub type OC4M_3_R = OC3M_3_R;
///Field `OC4M_3` writer - Output compare 4 mode Refer to OC3M\[3:0\]
///description.
