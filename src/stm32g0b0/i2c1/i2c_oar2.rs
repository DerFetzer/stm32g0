...
pub enum OA2MSK_A {
    ...
    B_0X0 = 0,
    ///1: OA2\[1\]
    ///is masked and donât care. Only OA2\[7:2\]
    ///are compared.
    B_0X1 = 1,
    ///2: OA2\[2:1\]
    ///are masked and donât care. Only OA2\[7:3\]
    ///are compared.
    B_0X2 = 2,
    ///3: OA2\[3:1\]
    ///are masked and donât care. Only OA2\[7:4\]
    ///are compared.
    B_0X3 = 3,
    ///4: OA2\[4:1\]
    ///are masked and donât care. Only OA2\[7:5\]
    ///are compared.
    B_0X4 = 4,
    ///5: OA2\[5:1\]
    ///are masked and donât care. Only OA2\[7:6\]
    ///are compared.
    B_0X5 = 5,
    ///6: OA2\[6:1\]
    ///are masked and donât care. Only OA2\[7\]
    ///is compared.
    B_0X6 = 6,
    ///7: OA2\[7:1\]
    ///are masked and donât care. No comparison is done, and all (except reserved) 7-bit received addresses are acknowledged.
    B_0X7 = 7,
}
