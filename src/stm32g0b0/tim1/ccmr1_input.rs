...
///Field `IC2PSC` reader - Input capture 2 prescaler Refer to IC1PSC\[1:0\]
///description.
...
///Field `IC2PSC` writer - Input capture 2 prescaler Refer to IC1PSC\[1:0\]
///description.
...
///Field `IC2F` reader - Input capture 2 filter Refer to IC1F\[3:0\]
///description.
...
///Field `IC2F` writer - Input capture 2 filter Refer to IC1F\[3:0\]
///description.
pub struct IC2F_W<'a> {
    w: &'a mut W,
}
...
impl R {
    ...
    ///Bits 10:11 - Input capture 2 prescaler Refer to IC1PSC\[1:0\]
    ///description.
    #[inline(always)]
    pub fn ic2psc(&self) -> IC2PSC_R {
        IC2PSC_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    ///Bits 12:15 - Input capture 2 filter Refer to IC1F\[3:0\]
    ///description.
    #[inline(always)]
