...
///`read()` method returns [chep2r::R](R) reader structure
impl crate::Readable for CHEP2R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep2r::W](W) writer structure
impl crate::Writable for CHEP2R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP2R to value 0
