...
///`read()` method returns [chep7r::R](R) reader structure
impl crate::Readable for CHEP7R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep7r::W](W) writer structure
impl crate::Writable for CHEP7R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP7R to value 0
