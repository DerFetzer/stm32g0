...
///`read()` method returns [chep4r::R](R) reader structure
impl crate::Readable for CHEP4R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep4r::W](W) writer structure
impl crate::Writable for CHEP4R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP4R to value 0
