...
///`read()` method returns [chep0r::R](R) reader structure
impl crate::Readable for CHEP0R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chep0r::W](W) writer structure
impl crate::Writable for CHEP0R_SPEC {
    type Writer = W;
}
///`reset()` method sets CHEP0R to value 0
