...
pub struct MSK2_R(crate::FieldReader<bool, MSK2_A>);
impl MSK2_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for MSK2_R {
    type Target = crate::FieldReader<bool, MSK2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct MSK3_R(crate::FieldReader<bool, MSK3_A>);
impl MSK3_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for MSK3_R {
    type Target = crate::FieldReader<bool, MSK3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct MSK4_R(crate::FieldReader<bool, MSK4_A>);
impl MSK4_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for MSK4_R {
    type Target = crate::FieldReader<bool, MSK4_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
