...
///Field `RT16` reader - Rising trigger event configuration bit of Configurable Event line
pub type RT16_R = RT0_R;
///Field `RT16` writer - Rising trigger event configuration bit of Configurable Event line
pub struct RT16_W<'a> {
    w: &'a mut W,
}
impl<'a> RT16_W<'a> {
...
///Field `RT17` reader - Rising trigger event configuration bit of Configurable Event line
pub type RT17_R = RT0_R;
///Field `RT17` writer - Rising trigger event configuration bit of Configurable Event line
pub struct RT17_W<'a> {
    w: &'a mut W,
}
impl<'a> RT17_W<'a> {
...
///Rising trigger event configuration bit of Configurable Event line
pub type RT18_A = RT0_A;
///Field `RT18` reader - Rising trigger event configuration bit of Configurable Event line
pub type RT18_R = RT0_R;
///Field `RT18` writer - Rising trigger event configuration bit of Configurable Event line
pub struct RT18_W<'a> {
    w: &'a mut W,
}
impl<'a> RT18_W<'a> {
    ///Writes `variant` to the field
    #[inline(always)]
    pub fn variant(self, variant: RT18_A) -> &'a mut W {
        self.bit(variant.into())
    }
    ///Rising edge trigger is disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(RT18_A::DISABLED)
    }
    ///Rising edge trigger is enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(RT18_A::ENABLED)
    }
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
///Field `RT20` reader - Rising trigger event configuration bit of Configurable Event line
pub type RT20_R = RT0_R;
///Field `RT20` writer - Rising trigger event configuration bit of Configurable Event line
pub struct RT20_W<'a> {
    w: &'a mut W,
}
impl<'a> RT20_W<'a> {
...
impl R {
    ...
    ///Bit 16 - Rising trigger event configuration bit of Configurable Event line
    #[inline(always)]
    pub fn rt16(&self) -> RT16_R {
        RT16_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    ///Bit 17 - Rising trigger event configuration bit of Configurable Event line
    #[inline(always)]
    pub fn rt17(&self) -> RT17_R {
        RT17_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    ///Bit 18 - Rising trigger event configuration bit of Configurable Event line
    #[inline(always)]
    pub fn rt18(&self) -> RT18_R {
        RT18_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    ///Bit 20 - Rising trigger event configuration bit of Configurable Event line
    #[inline(always)]
