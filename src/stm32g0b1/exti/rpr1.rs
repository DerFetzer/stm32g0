...
///Rising edge event pending for configurable line
pub type RPIF20_A = RPIF0_A;
///Field `RPIF20` reader - Rising edge event pending for configurable line
pub type RPIF20_R = RPIF0_R;
///Rising edge event pending for configurable line
pub type RPIF20_AW = RPIF0_AW;
///Field `RPIF20` writer - Rising edge event pending for configurable line
pub struct RPIF20_W<'a> {
    w: &'a mut W,
}
impl<'a> RPIF20_W<'a> {
    ///Writes `variant` to the field
    #[inline(always)]
    pub fn variant(self, variant: RPIF20_AW) -> &'a mut W {
        self.bit(variant.into())
    }
    ///Clears pending bit
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
        self.variant(RPIF20_AW::CLEAR)
    }
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn rpif20(&self) -> RPIF20_R {
        RPIF20_R::new(((self.bits >> 20) & 0x01) != 0)
    }
}
impl W {
    ///Bit 0 - Rising edge event pending for configurable line
    ...
    ///Bit 20 - Rising edge event pending for configurable line
    #[inline(always)]
    pub fn rpif20(&mut self) -> RPIF20_W {
        RPIF20_W { w: self }
    }
