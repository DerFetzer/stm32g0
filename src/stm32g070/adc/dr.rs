...
///Field `regularDATA` reader - ADC group regular conversion data
pub struct REGULARDATA_R(crate::FieldReader<u16, u16>);
impl REGULARDATA_R {
    pub(crate) fn new(bits: u16) -> Self {
        REGULARDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REGULARDATA_R {
