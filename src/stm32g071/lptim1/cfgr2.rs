...
///Field `IN2SEL` reader - LPTIM1 Input 2 selection
...
///Field `IN2SEL` writer - LPTIM1 Input 2 selection
...
///Field `IN1SEL` reader - LPTIMx Input 1 selection
...
///Field `IN1SEL` writer - LPTIMx Input 1 selection
