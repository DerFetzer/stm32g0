...
///Field `SQ1` reader - conversion of the sequence
...
///Field `SQ1` writer - conversion of the sequence
pub struct SQ1_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ1_W<'a> {
...
///Field `SQ2` reader - conversion of the sequence
...
///Field `SQ2` writer - conversion of the sequence
pub struct SQ2_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ2_W<'a> {
...
///Field `SQ3` reader - conversion of the sequence
...
///Field `SQ3` writer - conversion of the sequence
pub struct SQ3_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ3_W<'a> {
...
///Field `SQ4` reader - conversion of the sequence
...
///Field `SQ4` writer - conversion of the sequence
pub struct SQ4_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ4_W<'a> {
...
///Field `SQ5` reader - conversion of the sequence
...
///Field `SQ5` writer - conversion of the sequence
pub struct SQ5_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ5_W<'a> {
...
///Field `SQ6` reader - conversion of the sequence
...
///Field `SQ6` writer - conversion of the sequence
pub struct SQ6_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ6_W<'a> {
...
///Field `SQ7` reader - conversion of the sequence
...
///Field `SQ7` writer - conversion of the sequence
pub struct SQ7_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ7_W<'a> {
...
///Field `SQ8` reader - conversion of the sequence
...
///Field `SQ8` writer - conversion of the sequence
pub struct SQ8_W<'a> {
    w: &'a mut W,
}
impl<'a> SQ8_W<'a> {
