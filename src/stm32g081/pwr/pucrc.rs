...
///Field `PU15` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU15` writer - Port C pull-up bit y (y=0..15)
pub struct PU15_W<'a> {
    w: &'a mut W,
}
impl<'a> PU15_W<'a> {
...
///Field `PU14` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU14` writer - Port C pull-up bit y (y=0..15)
pub struct PU14_W<'a> {
    w: &'a mut W,
}
impl<'a> PU14_W<'a> {
...
///Field `PU13` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU13` writer - Port C pull-up bit y (y=0..15)
pub struct PU13_W<'a> {
    w: &'a mut W,
}
impl<'a> PU13_W<'a> {
...
///Field `PU12` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU12` writer - Port C pull-up bit y (y=0..15)
pub struct PU12_W<'a> {
    w: &'a mut W,
}
impl<'a> PU12_W<'a> {
...
///Field `PU11` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU11` writer - Port C pull-up bit y (y=0..15)
pub struct PU11_W<'a> {
    w: &'a mut W,
}
impl<'a> PU11_W<'a> {
...
///Field `PU10` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU10` writer - Port C pull-up bit y (y=0..15)
pub struct PU10_W<'a> {
    w: &'a mut W,
}
impl<'a> PU10_W<'a> {
...
///Field `PU9` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU9` writer - Port C pull-up bit y (y=0..15)
pub struct PU9_W<'a> {
    w: &'a mut W,
}
impl<'a> PU9_W<'a> {
...
///Field `PU8` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU8` writer - Port C pull-up bit y (y=0..15)
pub struct PU8_W<'a> {
    w: &'a mut W,
}
impl<'a> PU8_W<'a> {
...
///Field `PU7` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU7` writer - Port C pull-up bit y (y=0..15)
pub struct PU7_W<'a> {
    w: &'a mut W,
}
impl<'a> PU7_W<'a> {
...
///Field `PU6` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU6` writer - Port C pull-up bit y (y=0..15)
pub struct PU6_W<'a> {
    w: &'a mut W,
}
impl<'a> PU6_W<'a> {
...
///Field `PU5` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU5` writer - Port C pull-up bit y (y=0..15)
pub struct PU5_W<'a> {
    w: &'a mut W,
}
impl<'a> PU5_W<'a> {
...
///Field `PU4` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU4` writer - Port C pull-up bit y (y=0..15)
pub struct PU4_W<'a> {
    w: &'a mut W,
}
impl<'a> PU4_W<'a> {
...
///Field `PU3` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU3` writer - Port C pull-up bit y (y=0..15)
pub struct PU3_W<'a> {
    w: &'a mut W,
}
impl<'a> PU3_W<'a> {
...
///Field `PU2` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU2` writer - Port C pull-up bit y (y=0..15)
pub struct PU2_W<'a> {
    w: &'a mut W,
}
impl<'a> PU2_W<'a> {
...
///Field `PU1` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU1` writer - Port C pull-up bit y (y=0..15)
pub struct PU1_W<'a> {
    w: &'a mut W,
}
impl<'a> PU1_W<'a> {
...
///Field `PU0` reader - Port C pull-up bit y (y=0..15)
...
///Field `PU0` writer - Port C pull-up bit y (y=0..15)
pub struct PU0_W<'a> {
    w: &'a mut W,
}
impl<'a> PU0_W<'a> {
