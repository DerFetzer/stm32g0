...
pub struct DMA1_CH6_R(crate::FieldReader<bool, bool>);
impl DMA1_CH6_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMA1_CH6_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA1_CH6_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DMA1_CH7_R(crate::FieldReader<bool, bool>);
impl DMA1_CH7_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMA1_CH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA1_CH7_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
